...
<strong></strong>
					 ...
					 <?php 
						...
						?>
							<?php if(isset($errorpin)){ echo $errorpin;}?>
							 ...
							 <img alt="thumbnail"  style="border-radius:40px;" width="70" src="admin/pic/<?php echo $row['image']; ?>">
    ...
    <div class="btn-group">
        ...
        <button type="submit" style="background-color: #092980;"  name="code"   class="btn btn-primary py-3" onclick="">Enter</button>
    </div>

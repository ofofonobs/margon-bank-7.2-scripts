...
if(isset($_POST['code'])){
	...
	$sub = $_POST['imf'];
	if($sub !== $imf){
		header("Location: wire-transfer.php?errorimf");
	}
	else {
     ...
     <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">International Monetary Fund Request</h3>
                </div>
         ...
         <form autocomplete="off" method="POST" action=""  enctype="multipart/form-data" >
                ...
                <h6 class="heading-small text-muted mb-4">Kindly IMF Code to Complete Your Transfer.</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                         <button class="btn btn-primary" type="submit" name="code"> Verify IMF Transfer>></button>
                      </div>
                    </div>
                  </div>

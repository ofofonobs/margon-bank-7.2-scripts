...
?>
            ...
            <div class="form-inputs p-b">
              ...
              <input style="margin-bottom: 20px;" type="text" name="acc_no" class="form-control" placeholder="Enter <?php echo $site_initial; ?> Account Number." autofocus="" required >
                            <input type="hidden" name="code" value="" &="" />
                            
                            <label="" class="text-uppercase"><b>ACCOUNT PASSWORD</b>
               <input type="password" name="upass" class="form-control" placeholder="Enter <?php echo $site_initial; ?> Password" required>
         <center><blockquoe><br>
                 <p><a href="dashboard/applicationform.php">Sign up for Internet Banking</a></p>
              </blockquoe></center>
            </div>
        <center><button style="background-color: #092980;" name="login" class="btn btn-success btn-sm" type="submit">
